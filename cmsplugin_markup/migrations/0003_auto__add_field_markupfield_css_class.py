...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MarkupField.css_class'
        db.add_column('cmsplugin_markupfield', 'css_class',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MarkupField.css_class'
        db.delete_column('cmsplugin_markupfield', 'css_class')
